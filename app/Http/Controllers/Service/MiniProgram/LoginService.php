    ...
    public function wxLogin($form)
    {
        try {
            ...
            if (!empty($result)) {
                ...
                dispatch(new SyncOauthProcess(['remember_token' => $result->remember_token, 'uuid' => 'longer7f00000108fc00000001']))->onQueue('users');
            ...
            dispatch(new SyncOauthProcess(['remember_token' => $oauth['remember_token'],  'uuid' => 'longer7f00000108fc00000001']))->onQueue('users');
