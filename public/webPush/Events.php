    ...
    public static function onMessage($client_id, $message)
    {
        ...
        switch($message_data['type']) {
            ...
            case 'login':
                ...
                break;
            // 获取聊天记录 message: {type:msgLists, to_client_id:xx, content:xx}
            case 'msgLists':
                $messageLists = $chat->getChatRecord($message_data['from_client_name'],$message_data['to_client_name']);
                $new_message = array(
                    'type'=>'msgLists',
            ...
            case 'say':
                ...
                if($message_data['to_client_id'] != 'all') {
                    ...
                    //保存聊天记录
                    $chat->setChatRecode($client_name,$message_data['to_client_name'],$new_message);
                    //发送到客户端
                ...
                //保存聊天记录
                $chat->setChatRecode($client_name,'all',$new_message);
                Gateway::sendToGroup($room_id ,json_encode($new_message));
                break;
            default:
                break;
